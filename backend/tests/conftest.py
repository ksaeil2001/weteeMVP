...
# Note: JWT keys must be 32+ chars but <72 bytes (BCrypt limit)
os.environ.setdefault("JWT_SECRET_KEY", "test-jwt-secret-key-for-testing-32chars")
os.environ.setdefault("JWT_REFRESH_SECRET_KEY", "test-refresh-token-key-for-test-32ch")
os.environ.setdefault("JWT_ALGORITHM", "HS256")
os.environ.setdefault("ACCESS_TOKEN_EXPIRE_MINUTES", "15")
os.environ.setdefault("REFRESH_TOKEN_EXPIRE_DAYS", "7")
os.environ.setdefault("DEBUG", "True")
os.environ.setdefault("DATABASE_URL", "sqlite:///:memory:")
os.environ.setdefault("PROJECT_NAME", "WeTee Test")
